...
# CONFIG_TARGET_ipq806x_generic_DEVICE_ruijie_rg-mtfi-m520 is not set
...
CONFIG_PACKAGE_libdouble-conversion=m
...
CONFIG_PACKAGE_luci-app-ipsec-vpnserver-manyusers=m
...
CONFIG_PACKAGE_luci-i18n-ipsec-vpnserver-manyusers-zh-cn=m
...
CONFIG_PACKAGE_luci-i18n-mjpg-streamer-zh-cn=m
...
CONFIG_PACKAGE_transmission-remote-openssl=m
...
CONFIG_OVERRIDE_PKGS="coremark dns2socks frp ipt2socks luci-app-guest-wifi luci-app-ramfree luci-app-softethervpn luci-app-verysync nft-qos pdnsd-alt proxychains-ng samba4 shadowsocksr-libev simple-obfs smartdns softethervpn5 trojan v2ray v2ray-plugin verysync wget"
